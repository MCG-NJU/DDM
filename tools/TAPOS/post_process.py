...
def get_boundary_idx_per_video(
    scope, threshold, begin_ignore=1, end_ignore=1, seq_indices=None, seq_scores=None
):
...
def parse_args():
    ...
    parser.add_argument("--begin_ignore", type=int, default=1)
    parser.add_argument("--end_ignore", type=int, default=1)
